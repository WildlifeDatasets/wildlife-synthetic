# 📚 Wildlife Synthetic - Documentation

This directory contains the **MkDocs**-powered documentation for generation of Synthetic data.  
...
First, make sure you have **Python 3.12+**.
...
- For more help, open a [GitHub Issue](https://github.com/BohemianVRA/tgpr/issues).
